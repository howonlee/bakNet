...
\begin{frame}
  ...
  %%% maybe too much effort: look at the weights 
  %%%% chart of the classification performance on the pictures task: tau-eo, eo, gradient descent
\end{frame}

\begin{frame}
  \frametitle{Problems, Issues}
  Comparison to Ising model not that good
  Results
\end{frame}
