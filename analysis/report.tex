...
%%%%% necker cube necker cube necker cube
%%%%% necker cube necker cube necker cube
%%%%% necker cube necker cube necker cube
%%%%% necker cube necker cube necker cube
...
Note that there is a longer tail on the simulated annealing with an annealing schedule. This is because in those cases, the simulated annealing is stuck in a local optima, and is also at a low temperature, meaning that they cannot escape this local optima.

%%% note the virtue of making some progress or making some nonoptimal step, instead of haiving a well-defined tohught
